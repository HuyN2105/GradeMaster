...
$widgets_act = isset($widgets_act) ? $widgets_act : "";
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				<div class="profile-usertitle-name">'.$_COOKIE['username'].'</div>
		...
		<ul class="nav menu">
			...
			<li class = "'.$widgets_act.'"><a href="widgets.php"><em class="fa fa-calendar">&nbsp;</em> Widgets</a></li>
